        ...
        for patient, appointments in patient_schedule.items():
            ...
            for appointment in appointments:
                ...
                for service in speciality_service.services.all():
                    ...
                    headers = {'Authorization': f'Token 880430a839696607383313b109e5a0599617219b'}
                    result = requests.post("http://82.200.165.222:19603/api/customer_personal_cabinet/schedule_create",
...
class AggregateFreeSlotsView(View):
    ...
    def get(self, request):
        ...
        specializations = self.get_speciality_services_by_program(program_id)
        ...
        headers = {'Authorization': 'Token 880430a839696607383313b109e5a0599617219b'}
        response = requests.get(f"http://82.200.165.222:19603/api/customer_personal_cabinet/aggregat/free/slots", params=params, headers=headers)
...
class CustomerContractExaminationAppointmentsListView(ListView):
    ...
    def get_queryset(self):
        qs = super().get_queryset()
        professional_examination_id = self.kwargs.get('pk')
        return qs.filter(professional_examination=professional_examination_id)
